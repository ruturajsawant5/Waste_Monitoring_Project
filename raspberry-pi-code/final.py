...
while True:
    ...
    if distance < BIN_DIST1 :
        ...
        if(val1>90 or val2>90 or val3>90):
            ...
            querystring = {"authorization":"4ok8anAcO5xCsWMPBhQG02FItuS97DjLdRKvT1YfNUJZEylw3pfHbNi4ICY2OAaGsn5QJeKzlP3B9kvm","sender_id":"FSTSMS","message":realmsg,"language":"english","route":"p","numbers":"7020564821"}
